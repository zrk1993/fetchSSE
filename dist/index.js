...
function fetchSSE(url, init) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var onMessage, fetchOptions, res, reason, err_1, parser, body_1, _d, _e, _f, chunk, str, e_1_1;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    onMessage = init.onMessage, fetchOptions = __rest(init, ["onMessage"]);
                    return [4 /*yield*/, (0, node_fetch_1.default)(url, fetchOptions)];
                case 1:
                    res = _g.sent();
                ...
                case 4:
                    ...
                    return [3 /*break*/, 5];
                case 5: throw new Error("ChatGPT error ".concat(res.status, ": ").concat(reason));
                case 6:
